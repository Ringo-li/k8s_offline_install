...
iptables -t nat -A PREROUTING -d 172.31.33.20 -p tcp --dport 443 -j DNAT --to 192.168.33.100:443
iptables -t nat -A POSTROUTING -d 192.168.33.100 -p tcp --dport 443 -j SNAT --to 192.168.33.20
iptables -t nat -A PREROUTING -d 172.31.33.20 -p tcp --dport 80 -j DNAT --to 192.168.33.100:80
